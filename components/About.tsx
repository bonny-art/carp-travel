...
const About = () => {
  ...
  return (
    <section className=" py-14 md:py-16 lg:py-20 bg-about-xs sm+:bg-about-sm sm+:bg-left md+:bg-about-md lg+:bg-about-lg  ">
      <div className="outline outline-2 outline-red-400 max-container padding-container overflow-hidden flexStart flex-col gap-5 md:gap-16 lg:flex-row lg:gap-6">
        {isMobile && (
          <>
            ...
            <div className="w-[180px] self-end">
              <p className="regular-14-20-0 uppercase">{ABOUT.slogan.first}</p>
        ...
        {isDesktop && (
          <>
            ...
            <div className="w-full flexStart flex-col gap-[72px]">
