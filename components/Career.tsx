      ...
      {isMobile ? (
        <>
          <div className="py-14 bg-career-xs">
            <div className="container overflow-hidden flexStart flex-col gap-6">
        ...
        <div className="container overflow-hidden lg:py-6 flexStart flex-col gap-[5px]">
          <div className="flexBetween">
            <h2 className="thin-67-auto--4 lg:thin-98-auto--4 uppercase">
              {content.career.title.text}
              <span className="font-medium">{content.career.title.accent}</span>
            </h2>
